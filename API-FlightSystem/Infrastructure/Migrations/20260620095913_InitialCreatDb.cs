        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountRate = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PassengerTypes", x => x.TypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsChange = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlaneId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PlaneModel = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    AirlineId = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Passengers_PassengerTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatTemplates", x => x.SeatId);
                    table.ForeignKey(
                        name: "FK_SeatTemplates_SeatClasses_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BookingCode = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    ClassId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    JwtId = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    Token = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ExpiryTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    InRevoked = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightSeatPrices", x => new { x.FlightId, x.ClassId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightSeatPrices_SeatClasses_ClassId",
                        column: x => x.ClassId,
                        principalTable: "SeatClasses",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatId = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    LockedUntil = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    LockedBy = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightSeats_SeatTemplates_SeatId",
                        column: x => x.SeatId,
                        principalTable: "SeatTemplates",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightServices", x => new { x.FlightId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingDetailId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BookingId = table.Column<int>(type: "integer", nullable: false),
                    BookingFlightId = table.Column<int>(type: "integer", nullable: false),
                    PassengerId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingDetails_FlightSeats_FlightSeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingDetails_FlightSeatId",
                table: "BookingDetails",
                column: "FlightSeatId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Flights",
                columns: new[] { "DepartureTime", "RouteId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightSeatPrices_ClassId",
                table: "FlightSeatPrices",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightSeat_Availability",
                table: "FlightSeats",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "FlightSegments",
                columns: new[] { "FlightId", "SegmentOrder" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Route_Origin_Destination",
                table: "Routes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatTemplates_ClassId",
                table: "SeatTemplates",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatTemplates_RowIndex_ColIndex",
                table: "SeatTemplates",
                columns: new[] { "RowIndex", "ColIndex" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SeatTemplates_SeatNumber",
                table: "SeatTemplates",
                column: "SeatNumber");

            migrationBuilder.CreateIndex(
                name: "IX_SupportRequest_Status",
