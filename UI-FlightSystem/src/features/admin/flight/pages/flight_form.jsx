...
import { COMMON_RULES, SEAT_CLASSES, EDIT_STATUS_OPTIONS } from "../flight_constants";
import "./flight.css";
...
function FlightFormPage() {
    ...
    const redirectToList = () => navigate(`${PATHS.ADMIN.ROOT}/${PATHS.ADMIN.FLIGHTS}`);
    ...
    useEffect(() => {
        ...
        flightService
            .getById(id)
            .then(({ data }) => {
                if (data.succeeded) setFlightData(data.result);
            })
            .catch(console.error);
    }, [id, isEdit]);
    ...
    const { register, control, onSubmit, formState: { errors, isSubmitting },
        watch, setValue, segmentFields, appendSegment, removeSegment, seatPriceFields,
        serviceIds, toggleService,
    } = useFlightForm({
        mode, flightData, onSuccess: redirectToList, onClose: redirectToList,
    });
    ...
    const routeOptions = useMemo(
        () =>
            routes.map((r) => ({
                id: String(r.routeId),
                name: `${r.originAirportCode} (${r.originAirportName}) → ${r.destinationAirportCode} (${r.destinationAirportName})`,
            })),
        [routes]
    );

    const segmentRouteOptions = useMemo(
        () =>
            routes.map((r) => ({
                id: String(r.routeId),
                name: `${r.originAirportCode} → ${r.destinationAirportCode}`,
            })),
        [routes]
    );
        ...
        <div className="ff_container">
            <div className="ff_page_header">
                ...
                <div className="ff_page_actions">
                    <button type="button" className="btn_cancel" onClick={redirectToList}>
                    ...
                    <div className="ff_main">
                                    ...
                                    {isEdit && (
                                        <div className="form_group">
                                            ...
                                            <select {...register("status")}>
                                                {currentStatus === "Inactive" && (<option value="Inactive">Ngừng hoạt động</option>)}
                        ...
                        <div className="ff_card">
                            <div className="ff_section_header">
                                ...
                                <div>
                                    <div className="ff_section_title">
                                        <i className="bx bx-map-alt" /> Chặng bay
                                    </div>
                    ...
                    <div className="ff_sidebar">
                        <div className="ff_card">
                            <div className="ff_section_header">
                                ...
                                <div>
                                    <div className="ff_section_title">
                                        <i className="bx bx-purchase-tag" /> Giá vé theo hạng ghế
                                    </div>
                                        ...
                                        return (
                                            <div key={field.id} className="ff_seat_price_item">
                                                ...
                                                <div className="ff_seat_price_input">
                                                    <input {...register(`seatPrices.${index}.price`, { required: `Giá ${SEAT_CLASSES[index]?.className} không được để trống`,
                                                ...
                                                {formatted && (
                                                    <div className="ff_seat_price_preview">{formatted}</div>
                                                )}
