...
function AccountForm({ isOpen, onClose, onSave, accountData, mode }) {
    const { register, onSubmit, formState: { errors, isSubmitting, }, isEdit,
    } = useAccountForm({ mode, accountData, onSuccess: onSave, onClose });
                ...
                <form className="form_modal_content" onSubmit={onSubmit}>
                    ...
                    <div className="form_grid_two">
                        ...
                        <div className={`form_group ${errors.phoneNumber ? "has_error" : ""}`}>
                            ...
                            <input {...register("phoneNumber")} type="tel" placeholder="Nhập số điện thoại"/>
