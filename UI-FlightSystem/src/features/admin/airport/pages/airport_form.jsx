...
import { COMMON_RULES } from "../airport_constants";
...
function AirportForm({ isOpen, onClose, onSave, airportData, mode }) {
    ...
    } = useAirportForm({ mode, airportData, onSuccess: onSave, onClose });

    const countryOptions = useMemo(
        () => countries.map((country) => ({ id: country.cca2, name: country.translations.vie?.common ?? country.name.common }))
                    ...
                    <div className="form_grid_two">
                        ...
                        <div className={`form_group ${errors.city ? "has_error" : ""}`}>
                            ...
                            <Controller
                                ...
                                control={control}
                                render={({ field }) => (
                                    <input {...register("city")} placeholder="Nhập tên thành phố" disabled={!field.value}
                                    />
                                )}
                            />
