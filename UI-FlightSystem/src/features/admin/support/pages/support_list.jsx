...
import { REQUEST_TYPE_LABEL, REQUEST_TYPE_OPTIONS, SUPPORT_STATUS_CLASS, SUPPORT_STATUS_LABEL, TABLE_HEADS } from "../support_constants";
...
function SupportList() {
    ...
    const { items, pageIndex, pageSize, totalPages, totalCount, isLoading, error, refresh, requestType, status
    } = useDataList({
        sliceName: "supportRequest",
        fetchListThunk: fetchSupportRequests,
    ...
    const { handleFilterChange: handleTypeChange } = useSearchFilter({
        sliceName: "supportRequest",
        setFilterAction: setRequestType,
    });

    const { handleFilterChange: handleStatusChange } = useSearchFilter({
        sliceName: "supportRequest",
        ...
        <div className="list_container">
            ...
            <div className="list_toolbar">
                <div className="filter_select">
                    <select value={requestType} onChange={(e) => handleTypeChange(e.target.value)}>
            ...
            <main className="table_card_wrapper">
                <Table
                    ...
                    isLoading={isLoading}
                    render={(item, index) => {
                        const statusClass = SUPPORT_STATUS_CLASS[item.status] ?? "status_pending";
                        return (
