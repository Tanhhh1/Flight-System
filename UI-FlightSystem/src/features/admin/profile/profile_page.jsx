...
import "./profile.css";
import { useProfileForm } from "@/features/profile/hooks/use_profile_form";
import { useChangePassword } from "@/features/profile/hooks/use_change_password";
...
function ProfilePage() {
    ...
    const {
        register: regProfile,
        formState: { errors: pErr, isSubmitting: isProfileSubmitting },
        onSubmit: submitProfile,
    } = useProfileForm({ onSuccess: showAlert });

    const {
        reg: regPassword,
        formState: { errors: pwErr, isSubmitting: isPasswordSubmitting },
        onSubmit: submitPassword,
    } = useChangePassword({ onSuccess: showAlert });
