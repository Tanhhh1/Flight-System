...
import { FEATURES } from "../homepage_constants";
import SearchForm from "../pages/components/search_form";
import ReviewList from "../pages/components/review_list";
import "./homepage.css";

function Homepage() {
    const dispatch = useDispatch();
    // Khai báo đúng key "homepage" đã đăng ký trong store.js
        ...
        <div className="home_container">
            <section className="hero_section">
                ...
                <div className="hero_content">
                    ...
                    <p className="hero_subtitle">
                        Tìm kiếm vé máy bay giá rẻ, trải nghiệm chuyến đi an toàn cùng SkyJourney
                    </p>
            ...
            <section className="section reviews_section">
                <div className="section_header text_center_wrapper">
                    ...
                    <p className="section_subtitle text_center">
                        Những chia sẻ chân thực từ các hành khách đã trải nghiệm dịch vụ
                    </p>
                </div>
