...
import { DEFAULT_SINGLE_FLIGHT, DEFAULT_MULTI_FLIGHTS, MAX_MULTI_FLIGHTS, SEAT_CLASS_ID_MAP } from "../../homepage_constants";
import "../homepage.css";
...
function SearchForm({ airports = [], isModalView = false, onSuccess }) {
    ...
    useEffect(() => {
        if (!isModalView || airports.length === 0) return;
    ...
    const handleSearchSubmit = (e) => {
        ...
        navigate(`${PATHS.CLIENT.SEARCH}?${qs.toString()}`);
        onSuccess?.();
    };
                ...
                {searchType === "one-way-round" ? (
                    <div className="form_row_block_group single_layout">
                        ...
                        <div className="swap_btn_container">
                            <button
                                type="button"
                                className="swap_locations_action"
                                onClick={handleSwapSingleLocations}
                                title="Đổi chiều"
                            >
                        ...
                        <div className="input_field_container">
                            ...
                            <div className="input_field_inner">
                                ...
                                <input
                                    type="date"
                                    min={today}
                                    value={singleFlight.departureDate}
                                    onChange={(e) =>
                                        setSingleFlight({
                                            ...singleFlight,
                    ...
                    <div className="multi_city_container">
                                ...
                                <div className="form_row_block_group multi_layout" key={flight.id}>
                                    ...
                                    <div className="swap_btn_container">
                                        <button
                                            type="button"
                                            className="swap_locations_action"
                                            onClick={() => handleSwapMultiLocations(idx)}
                                            title="Đổi chiều"
                                        >
                                            <i className="bx bx-transfer-alt"></i>
                                        </button>
                                    ...
                                    <div className="input_field_container">
                                        ...
                                        <div className="input_field_inner">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    handleFlightChange(idx, "departureDate", e.target.value)
                                                }
                                                required
                                            />
                                        </div>
                                    ...
                                    <div className="input_field_container delete_action_container">
                                        {flights.length > 2 ? (
                                            <>
                                                <label className="input_field_title highlight_red_text">
                                                    Xóa
                                                </label>
                                                <button
                                                    type="button"
                                                    className="btn_remove_flight"
                        ...
                        <div className="multi_city_bottom_actions">
                            {flights.length < MAX_MULTI_FLIGHTS ? (
                                <button
                                    type="button"
                                    className="btn_add_flight_dashed"
                                    onClick={handleAddFlight}
                                >
                                    <i className="bx bx-plus-circle"></i> THÊM CHUYẾN BAY KHÁC (
                                    {flights.length}/{MAX_MULTI_FLIGHTS})
                                </button>
                            ) : (
                                <span className="max_flights_alert">
                                    <i className="bx bx-info-circle"></i> Giới hạn tối đa{" "}
                                    {MAX_MULTI_FLIGHTS} chặng bay
                                </span>
                            )}
