...
import { setFilters, resetFilters, fetchFilterData } from "../../search_slice";
import { TIME_SLOTS, STOP_OPTIONS } from "../../search_constants";
import "../styles/flight_sidebar.css"
...
function FilterSidebar() {
    ...
    }, [dispatch, filterData.airlines.length, filterData.services.length, filterData.loading]);
