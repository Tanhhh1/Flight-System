...
import { SEAT_CLASS_OPTIONS } from "../../search_constants"
        ...
        <div className="flight_detail_wrapper">
            <div className="detail_class_header">
                <div className="flight_class_badge">
                    <span className="detail_class_badge">
                        <i className="bx bx-diamond" /> {seatClass?.className ? (SEAT_CLASS_OPTIONS[seatClass.className] ?? seatClass.className) : "—"}
                    </span>
                    {seatClass && (
