...
import { fetchMyReviews, setPage } from "../../review/review_slice";
import { useReviewForm } from "../../review/use_review_form";
...
function Review() {
    ...
    useEffect(() => {
        dispatch(fetchMyReviews({ pageIndex, pageSize: 5 }));
    }, [dispatch, pageIndex]);
                    ...
                    <div className="panel_body">
                        ...
                        <div className="form_group_full">
                            ...
                            <textarea
                                ...
                                placeholder="Hãy viết cảm nhận, lỗi hệ thống gặp phải hoặc đề xuất tính năng mới mà bạn mong muốn có..."
                                rows="5"
                            />
