...
import { createSupportRequest, resetCreate } from "../../../support/support_slice";
import { flightSearchService } from "@/features/client/search/search_service";
import { formatDate, formatTime } from "@/utils/date_utils";
import { REQUEST_TYPE_ENUM } from "@/features/admin/support/support_constants";
import { REQUEST_TYPES } from "@/features/profile/profile_constants"
                ...
                <div className="panel_body support_form_body">
                    ...
                    <div className="support_form_section">
                        ...
                        <div className="support_type_tabs">
                            {REQUEST_TYPES.map((t) => (
                                <button key={t.value} className={`support_type_tab ${requestType === t.value ? "active" : ""}`}
                    ...
                    {requestType === "Refund" && (
                        <div className="support_form_section">
                            ...
                            <textarea id="refund_reason" className="support_textarea" rows={5} placeholder="Mô tả lý do bạn muốn hoàn vé..." value={reason}
                        ...
                        <>
                            <div className="support_form_section">
                                ...
                                <div className="support_search_row">
                                    <input type="date" className="support_date_input" value={searchDate}
                                        min={new Date().toISOString().split("T")[0]} onChange={(e) => setSearchDate(e.target.value)} />
                            ...
                            {flightSearchResults.map((flight) => (
                                <div key={flight.flightId} className={`support_flight_card ${selectedFlightId === flight.flightId ? "selected" : ""}`}
                            ...
                            <div className="support_form_section">
                                ...
                                <textarea id="reschedule_reason" className="support_textarea" rows={3} placeholder="Thêm ghi chú nếu cần..."
