import "../styles/passenger_panel.css"
            ...
            <div className="passenger_panel_list">
                {passengers.map((p) => {
                    ...
                    return (
                        <button
                            key={p.passengerId}
                            className={`passenger_card ${isSelected ? "passenger_card_active" : ""} ${pending ? "passenger_card_assigned" : ""}`}
                            onClick={() => onSelectPassenger(isSelected ? null : p.passengerId)}
                        >
